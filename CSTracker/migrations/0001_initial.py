# Generated by Django 5.2.5 on 2025-12-06 14:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='CSTracker.program')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='CSTracker.studentprofile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submissions', to='CSTracker.programapplication')),
            ],
        ),
        migrations.CreateModel(
            name='ServiceLog',
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_logs', to='CSTracker.programapplication')),
            ],
        ),
        migrations.CreateModel(
            name='User',
